"""
This python script is used for demonstrating manual driving using a dualshock2
Playstation Controller.

* Controls *
- Analog Left: Throttling
- Analog Right: Steering
- L1: Hand brake
- R1: Toggling Forward/Reverse Drive
- R2: Toggling Lane Detection
...
CAR_SPAWN_POINT = carla.Transform(carla.Location(x=-30, y=207.5, z=1)) # spawnpoint can be changed here
WRITE_VID   = False # set to true to record driving
...
def get_image(image):
    """
        Convert output from Carla to make it compatible with OpenCV 
    """
...
### OBSTACLE DETECTOR FNS & VARIABLES ###
...
try:
    ...
    use_lane_detect = True # flag to toggle lane detection
